...
echo -e "\033[33m *                                                                                 * \033[0m"
echo -e "\033[33m * Antes de utilizar o script, é importante que você faça uma avaliação cuidadosa e*\n *compreenda as implicações do seu uso. \033[31mCertifique-se de que o script é    \033[33m*\033[0m\n *\033[31mseguro e adequado\033[33m para as suas necessidades antes de utilizá-lo.  *\033[0m"
echo -e "\033[33m *                                                                                 * \033[0m"
