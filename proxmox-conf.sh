...
echo -e " "
echo -e "\033[33m Em resumo, \033[31mutilize o script por sua conta e risco\033[33m. A pessoa ou\n empresa que forneceu o script não será responsável por quaisquer problemas ou danos causados\n pelo seu uso. \033[0m"
echo -e " "
echo -e "\033[33mAo pressionar uma tecla você concorda com os riscos...\033[0m"
read -p  " "
clear
